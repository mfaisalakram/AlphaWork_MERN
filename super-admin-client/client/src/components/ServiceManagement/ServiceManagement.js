...
const ServiceManagement = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/services/service-management')
      .then((res) => {
  ...
  let ChangeHandler = (id, type) => {
    axios
      .put('http://localhost:5000/api/services/service-management', {
        id: id,
        type: type,
      })
      .then((res) => {
  ...
  const SearchStatusHandler = (type) => {
    axios
      .post('http://localhost:5000/api/services/service-status', { type: type })
      .then((res) => {
        setservicesData(res.data);
      });
  };
  ...
  const SearchNameHandler = (id) => {
    axios
      .post('http://localhost:5000/api/services/search-name', { id: id })
      .then((res) => {
        setservicesData(res.data);
      });
  };
