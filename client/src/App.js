...
function App(props) {
  ...
  // const baseUrl = "http://www.eaglance.com";
  useEffect(() => {
  ...
  return (
    <Fragment >
      ...
      <ToastProvider>
        ...
        <PrivateRoute path="/messages"   render={props => <ChatBox {...props} baseUrl={baseUrl} />} />
        ...
        <PrivateRoute
          ...
          <PrivateRoute
            ...
            render={props => <ResolutionCenter {...props} baseUrl={baseUrl} />}
          />

           <PrivateRoute
            exact
            path="/users/:username/manage_orders/:orderId"
            render={props => <ViewOrderSeller {...props} baseUrl={baseUrl} />}
          />
           <PrivateRoute
            exact
            path="/users/:username/orders/:orderId"
            render={props => <ViewOrderBuyer {...props} baseUrl={baseUrl} />}
          />
          <PrivateRoute
            exact
            path="/services"
          ...
          <Route exact path="/reset"   render={props=><Forget  {...props} baseUrl={baseUrl}/> } />
          <PrivateRoute exact path="/aggrement/selling-on-eaglance"   render={props=><BecomeASeller  {...props} baseUrl={baseUrl}/> } />
